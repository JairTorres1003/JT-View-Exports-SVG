...
const AssetFiles = (): React.JSX.Element => {
  ...
  return (
    <AssetFilesBox>
      {[...assetFiles.user, ...assetFiles.workspace].length > 0 && (
        <Box className='AssetFilesBox__actions'>
          <Checkbox
            ...
            checked={checkedFiles.length === [...assetFiles.user, ...assetFiles.workspace].length}
            indeterminate={
              checkedFiles.length > 0 &&
              checkedFiles.length < [...assetFiles.user, ...assetFiles.workspace].length
            }
          />
