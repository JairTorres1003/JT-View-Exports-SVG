...
2. The **DevTools panel** opens automatically [(**default behavior**)](/docs/guides/settings#click-to-open-devtools).
3. You'll see:
...
<NextStepList list={['usage', 'devtools', 'svg-support', 'settings']} />
