...
You can follow the technical discussion and current status on [**GitHub**](https://github.com/microsoft/vscode/issues/255608?meta-props=[icon=external-link])
:::

### Related Reading

- [Usage →<strong className='ml-1'> Alternative Workflow: Drag & Drop</strong>](/docs/guides/usage?meta-props=[icon=true]#-alternative-workflow-drag--drop)
...
- Open a [**GitHub issue**](https://github.com/JairTorres1003/JT-View-Exports-SVG/issues?meta-props=[icon=external-link])
